...
# Você tem uma lista de e-mails
# de administradores: admins = ["ana@empresa.com", "guilherme@empresa.com", "felipe@empresa.com"]. 
...
if email in admins:
  print(f"{email} : Acesso liberado! Bem-vindo ao painel de controle.")
else:
  print(f"{email} : Acesso negado. Você não tem permissões de administrador.")