...
# O sistema de e-commerce descontinuou alguns produtos.
# Você tem o dicionário: produtos = {"celular": 1500, "camera": 800, "radio": 200, "fone": 100}. O item "radio" deve ser removido por estar obsoleto. Crie um código que:
...
produto_removido = produtos.pop('radio')
print(produto_removido)
print(produtos)
celular = 'celular' in produtos
print(celular)
