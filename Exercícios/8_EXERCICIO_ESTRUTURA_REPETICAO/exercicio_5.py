# Exercício 5: Reajuste Geral de Preços (Setor Comercial) Devido à inflação, 
# a empresa decidiu aumentar o preço de todos os seus produtos em um percentual
# decidido pelo usuário. O catálogo atual é: 
